...
class GenCadenaPagos {

    private static $XSLT_CADENAORIGINAL = 'http://http://omawww.sat.gob.mx/sitio_internet/cfd/Pagos/Pagos10.xslt';
    /** @var string */
    ...
    public static function cadenaOriginal($xml)
    {
        ...
        $xslt = static::cadenaoriginal_path('Pagos10.xslt');
        ...
        $xslt = (function ($file_xslt) {
            ...
            return $xslt;
        })(static::cadenaoriginal_path('Pagos10.xslt'));
